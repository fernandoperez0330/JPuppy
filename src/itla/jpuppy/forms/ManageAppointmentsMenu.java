...
public class ManageAppointmentsMenu extends javax.swing.JDialog implements FrameOption {
    ...
    private void setListener() {
        searching.getTxtSearch().addKeyListener(ctrlAppointments);
        searching.getTblResult().addMouseListener(ctrlAppointments);
